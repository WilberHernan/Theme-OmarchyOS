...
This copies: waybar style (rounded, transparent), Hyprland animations + rounding, Bibata cursor + GTK styling, custom walker theme,   mask, fish greeting.
...
- / —  oni-mask ASCII art, clean info display
- fish/config.fish —  on terminal open
